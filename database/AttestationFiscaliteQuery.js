...
exports.AttestationFiscalite = {
  ...
  getAllAttestation: `
    SELECT 
        ...
        CASE 
            WHEN att.[dateExpiration] IS NULL AND fou.[datecreation] IS NOT NULL AND fou.[datecreation] >= DATEADD(MONTH, -5, GETDATE())
        ...
        CASE 
            WHEN att.[dateExpiration] IS NULL AND fou.[datecreation] IS NOT NULL AND fou.[datecreation] >= DATEADD(MONTH, -5, GETDATE())
                THEN 6  -- Priorité 6 : Nouveau fournisseur (INFO)
